...
const azDeals: AZDeal[] = [
  {
    ...
    ltv: '80%',
    quote: "First lender walked away on my Phoenix rental two weeks in over a self-employment income issue. John got on the phone, walked through what actually killed it, and matched the file to a lender whose overlays fit. Qualified on the rent, not my tax returns. Felt like working with someone who'd seen this exact scenario a hundred times.",
  },
  {
    name: 'Sara L.',
    city: 'Scottsdale, AZ',
    type: 'Short-Term Rental',
    outcome: 'Scottsdale STR financed on AirDNA, no rental history',
    ltv: '75%',
    quote: "Bought a pool home near Old Town Scottsdale with zero rental history, planning to run it as a short-term rental. Most lenders ghosted me. John matched me with a lender that took AirDNA projections at a 75% factor and explained Arizona's statewide STR rules up front so I knew where I stood. First STR in the books.",
  },
  {
    name: 'Wei C.',
    city: 'Tempe, AZ',
    ...
    ltv: '70%',
    quote: "I live overseas and own two Arizona rentals already. Getting a third was supposed to be impossible. No SSN, no US credit history. John walked me through Foreign National DSCR, used my overseas credit reference, and closed the Tempe rental clean.",
  },
  {
    name: 'Priya S.',
    city: 'Tucson, AZ',
...
export default function TestimonialCarouselAZ() {
  ...
  const totalSlides = azDeals.length;
