...
const vaDeals: VADeal[] = [
  {
    ...
    ltv: '80%',
    quote: "First lender bailed on my Virginia Beach rental two weeks in over a self-employment income flag. John got on the phone, walked through what actually killed it, and matched the file to a lender whose overlays fit. Qualified on the rent, not my tax returns. The military renter demand made the rental numbers an easy story.",
  },
  {
    name: 'Tasha W.',
    city: 'Norfolk, VA',
    type: 'SFR Rental (military tenant)',
    outcome: 'Stable military-base rental, fast leaseup',
    ltv: '80%',
    quote: "Bought near the Norfolk naval base specifically for the steady military tenant base. Two lenders made my entity-held file complicated. John ran the DSCR on the market rent, showed me where it penciled, and routed it to a lender that closed fast. Leased to a Navy family within weeks.",
  },
  {
    name: 'Wei C.',
    city: 'Richmond, VA',
    ...
    ltv: '70%',
    quote: "I live overseas and already own two Virginia rentals. A third was supposed to be impossible. No SSN, no US credit history. John walked me through Foreign National DSCR, used my overseas credit reference, and closed the Richmond rental clean. Richmond's tight rental supply made the deal easy to justify.",
  },
  {
    name: 'Jordan B.',
    ...
    ltv: '75% ARV',
    quote: "First investment property ever. Dated townhouse in a Northern Virginia county with a rehab budget and an ARV well above purchase. John structured the bridge, then refi'd into DSCR at 75% of ARV once it was stabilized. Cash back out on the refi, and the DSCR penciled on the new rent. He talked through every step before we pulled the trigger.",
  },
];
...
export default function TestimonialCarouselVirginia() {
  ...
  const totalSlides = vaDeals.length;
