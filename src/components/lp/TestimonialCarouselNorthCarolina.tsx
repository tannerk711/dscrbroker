...
const ncDeals: NCDeal[] = [
  {
    ...
    ltv: '80%',
    quote: "First lender bailed on my Charlotte rental two weeks in over a self-employment income flag. John got on the phone, walked through what actually killed it, and matched the file to a lender whose overlays fit. Qualified on the rent, not my tax returns. Felt like working with someone who'd seen this exact scenario a hundred times.",
  },
  {
    name: 'Priya N.',
    city: 'Raleigh, NC',
    type: 'SFR Rental (Triangle)',
    outcome: 'Relocation-driven rental, leased before closing',
    ltv: '80%',
    quote: "Bought a single-family in a Raleigh suburb betting on the tech hiring around the Triangle. Two lenders made it complicated. John ran the DSCR on the projected rent, showed me where it penciled, and routed it to a lender that moved fast. It was leased to a relocating family before we even closed.",
  },
  {
    name: 'Wei C.',
    city: 'Durham, NC',
    ...
    ltv: '70%',
    quote: "I live overseas and already own two Carolina rentals. A third was supposed to be impossible. No SSN, no US credit history. John walked me through Foreign National DSCR, used my overseas credit reference, and closed the Durham rental clean.",
  },
  {
    name: 'Jordan B.',
    city: 'Asheville, NC',
...
export default function TestimonialCarouselNorthCarolina() {
  ...
  const totalSlides = ncDeals.length;
