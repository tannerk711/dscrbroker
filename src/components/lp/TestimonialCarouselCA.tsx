...
const caDeals: CADeal[] = [
  {
    ...
    ltv: '80%',
    quote: "First lender walked away on my Inland Empire rental two weeks in over a self-employment income issue. John got on the phone, walked through what actually killed it, and matched the file to a lender whose overlays fit. Qualified on the rent, not my tax returns. Felt like working with someone who'd seen this exact scenario a hundred times.",
  },
  {
    name: 'Jenna P.',
    city: 'Sacramento, CA',
    type: 'SFR Buy-and-Hold',
    outcome: 'Prop 13 reassessment caught before close',
    ltv: '75%',
    quote: "The number that almost killed my Sacramento deal was the property tax. The seller was paying way less than I would, because buying it resets the assessment to my purchase price under Prop 13. John caught it, re-ran the DSCR with the real tax bill, and restructured the down payment so the ratio still penciled. If I'd used the seller's tax number I'd have been upside down at closing.",
  },
  {
    name: 'Aaron W.',
    city: 'Bakersfield, CA',
    type: 'No-Ratio DSCR',
    outcome: 'No-ratio program, low DSCR market',
    ltv: '70%',
    quote: "Bakersfield cash flows better than the coast, but my numbers still came in under a 1.0 DSCR after the new tax bill. John moved me to a no-ratio DSCR program that doesn't require the ratio to clear 1.0, priced for the higher LTV. Closed my second Central Valley rental when two other brokers told me the deal was dead.",
  },
  {
    name: 'Sofia R.',
    city: 'Fresno, CA',
    ...
    ltv: '70%',
    quote: "I live overseas and own two California rentals already. Getting a third was supposed to be impossible. No SSN, no US credit history. John walked me through Foreign National DSCR, used my overseas credit reference, and closed the Fresno rental clean.",
  },
];
...
export default function TestimonialCarouselCA() {
  ...
  const totalSlides = caDeals.length;
