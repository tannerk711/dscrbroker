...
const nvDeals: NVDeal[] = [
  {
    ...
    ltv: '80%',
    quote: "First lender walked away on my Las Vegas rental two weeks in over a self-employment income issue. John got on the phone, walked through what actually killed it, and matched the file to a lender whose overlays fit. Qualified on the rent, not my tax returns. Felt like working with someone who'd seen this exact scenario a hundred times.",
  },
  {
    name: 'Sara L.',
    city: 'Henderson, NV',
    type: 'Short-Term Rental',
    outcome: 'Vegas-area STR financed on projections',
    ltv: '75%',
    quote: "Bought a Henderson home to run as a short-term rental for the Vegas tourism traffic, with no rental history of my own. Most lenders ghosted me. John matched me with a lender that took third-party projections at a 75% factor and walked me through confirming the local short-term-rental permitting before I closed, so I knew where I stood. First STR in the books.",
  },
  {
    name: 'Wei C.',
    city: 'Reno, NV',
    ...
    ltv: '70%',
    quote: "I live overseas and own two Nevada rentals already. Getting a third was supposed to be impossible. No SSN, no US credit history. John walked me through Foreign National DSCR, used my overseas credit reference, and closed the Reno rental clean.",
  },
  {
    name: 'Priya S.',
    city: 'Summerlin, NV',
...
export default function TestimonialCarouselNV() {
  ...
  const totalSlides = nvDeals.length;
