...
const coDeals: CODeal[] = [
  {
    ...
    ltv: '80%',
    quote: "First lender walked away on my Denver rental two weeks in over a self-employment income issue. John got on the phone, walked through what actually killed it, and matched the file to a lender whose overlays fit. Qualified on the rent, not my tax returns. Felt like working with someone who'd seen this exact scenario a hundred times.",
  },
  {
    name: 'Megan T.',
    city: 'Colorado Springs, CO',
    type: 'SFR Buy-and-Hold',
    outcome: 'Self-employed, no W-2s, clean close',
    ltv: '78%',
    quote: "I run my own business, so my tax returns make me look broke on paper even though the rental cash flows fine. Conventional lenders kept asking for two years of returns I couldn't make work. John ran the DSCR on the actual rent, and Colorado Springs property taxes are so low the ratio penciled easily. Closed on my third rental.",
  },
  {
    name: 'Daniel K.',
    city: 'Aurora, CO',
    ...
    ltv: '70%',
    quote: "I live overseas and own two Colorado rentals already. Getting a third was supposed to be impossible. No SSN, no US credit history. John walked me through Foreign National DSCR, used my overseas credit reference, and closed the Aurora rental clean.",
  },
  {
    name: 'Lauren B.',
...
export default function TestimonialCarouselCO() {
  ...
  const totalSlides = coDeals.length;
