...
const njDeals: NJDeal[] = [
  {
    name: 'Marcus D.',
    city: 'Jersey City, NJ',
    type: '2-4 Unit Rental',
    outcome: 'Declined elsewhere, closed at 80% LTV',
    ltv: '80%',
    quote: "First lender bailed on my Jersey City three-unit two weeks in over a self-employment income issue. John got on the phone, walked through what actually killed it, and matched the file to a lender whose overlays fit. Qualified on the rent, not my tax returns. Felt like working with someone who'd seen this exact scenario a hundred times.",
  },
  {
    name: 'Danielle R.',
    city: 'Newark, NJ',
    type: 'SFR Rental',
    outcome: 'Commuter rental, high carrying costs penciled',
    ltv: '75%',
    quote: "My Newark rental had heavy carrying costs and the DSCR looked tight on paper. John structured the file so the numbers worked and matched me with a lender comfortable with the dense-market rents. He knew the transit-commuter demand story cold, which is exactly why the deal made sense.",
  },
  {
    name: 'Wei C.',
    city: 'Edison, NJ',
    ...
    ltv: '70%',
    quote: "I live overseas and own two New Jersey rentals already. Getting a third was supposed to be impossible. No SSN, no US credit history. John walked me through Foreign National DSCR, used my overseas credit reference, and closed the Edison rental clean.",
  },
  {
    name: 'Priya S.',
    city: 'Asbury Park, NJ',
...
export default function TestimonialCarouselNJ() {
  ...
  const totalSlides = njDeals.length;
