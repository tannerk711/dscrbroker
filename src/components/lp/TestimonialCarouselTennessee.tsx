...
const tnDeals: TNDeal[] = [
  {
    ...
    ltv: '80%',
    quote: "First lender walked away on my Memphis rental two weeks in over a self-employment income issue. John got on the phone, walked through what actually killed it, and matched the file to a lender whose overlays fit. Qualified on the rent, not my tax returns. The low Tennessee carrying costs made the DSCR pencil easily.",
  },
  {
    name: 'Sara L.',
    city: 'Gatlinburg, TN',
    type: 'Short-Term Rental',
    outcome: 'Smokies cabin financed on a rental projection',
    ltv: '75%',
    quote: "Bought a cabin near Gatlinburg to run as a short-term rental, no rental history yet. Most lenders ghosted me. John matched me with a lender that took a rental projection at a conservative factor and walked me through the local STR permit rules up front so I knew where I stood. First STR in the books.",
  },
  {
    name: 'Anthony R.',
    city: 'Knoxville, TN',
    type: 'SFR Rental',
    outcome: 'No-tax-state cash flow, tight occupancy market',
    ltv: '80%',
    quote: "Knoxville stays at high occupancy and Tennessee has no state income tax, so the cash flow on paper looked great. Two lenders still made my self-employed file painful. John ran the real DSCR with the low property tax baked in, showed me the number, and routed it to a lender that closed it without the runaround.",
  },
  {
    name: 'Wei C.',
    city: 'Chattanooga, TN',
    ...
    ltv: '70%',
    quote: "I live overseas and own two Tennessee rentals already. Getting a third was supposed to be impossible. No SSN, no US credit history. John walked me through Foreign National DSCR, used my overseas credit reference, and closed the Chattanooga rental clean.",
  },
];
...
export default function TestimonialCarouselTennessee() {
  ...
  const totalSlides = tnDeals.length;
